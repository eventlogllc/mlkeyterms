    "what": [
      ...
      "[英] [related] representation, a machine learning system, learned, from, the training data.",
      "[和] [関連] 表現 [pronunciation] [hiragana or katakana], 機械学習システム [pronunciation] [hiragana or katakana], 学習済み [pronunciation] [hiragana or katakana], から [pronunciation] [hiragana or katakana], からトレーニングデータ [pronunciation] [hiragana or katakana]",	    
      "[漢] [相關] 表示，機器學習系統，學習，來自，訓練數據",  
    ],
