...
[かくステップでけいさん], 推定 [Suitei] [すいてい], 勾配を計算するために [Koubai wo Keisansuru tameni] [こうばいをけいさんするために], データセットから [Deeta setto kara] [データセットから], 選択された単一の例に依存する [Sentaku sareta tannitsu no reini izonsuru] [せんたくされた　たんいつのれいに　いぞんする]",	    
